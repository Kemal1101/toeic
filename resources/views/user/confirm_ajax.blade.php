        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-body">
                ...
                <table class="table table-sm table-bordered table-striped">
                    <tr><th class="text-right col-3">Role Pengguna :</th><td class="col-9">{{ $user->role->role }}</td></tr>
                    <tr><th class="text-right col-3">Username :</th><td class="col-9">{{ $user->username }}</td></tr>
                    <tr><th class="text-right col-3">Nama Lengkap :</th><td class="col-9">{{ $user->nama_lengkap }}</td></tr>
                </table>
            </div>
